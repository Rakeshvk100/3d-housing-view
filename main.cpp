...
void sofa1()
{
	...
	// extra sofaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa

	glColor3f(0.96, 0.64, 0.38);
	glPushMatrix();
	glTranslated(-0.2 + sofa_s, -0.225, 0 + sofa_d);		//bottom
	glScaled(2, 1.5, 6);
	glutSolidCube(0.1);
	glPopMatrix();
	...
	glColor3f(0.93, 0.84, 0.72);
	glPushMatrix();
	glTranslated(-0.2 + sofa_s, -0.1125, -0.25 + sofa_d);		//back
	glScaled(2, 0.75, 1);
	glutSolidCube(0.1);
	glPopMatrix();
	...
	glColor3f(0.93, 0.84, 0.72);
	glPushMatrix();
	glTranslated(-0.2 + sofa_s, -0.1125, 0.25 + sofa_d);		//front
	glScaled(2, 0.75, 1);
	glutSolidCube(0.1);
	glPopMatrix();
	...
	glColor3f(0.87, 0.72, 0.53);
	glPushMatrix();
	glTranslated(-0.275 + sofa_s, -0.075, -0.25 + sofa_d);			//rest
	glScaled(0.5, 1.5, 4);
	glutSolidCube(0.1);
	glPopMatrix();
...
void tree()
{
	...
	glColor3f(0, 0.39, 0);
	glPushMatrix();
	glTranslated(-0.85, -0.6, 0.4);
	glRotatef(-90, 1, 0, 0);
	glutSolidCone(0.1, 0.25, 400, 500);
	glPopMatrix();
	...
	glColor3f(0.56, 0.80, 0.20);
	glPushMatrix();
	glTranslated(-0.55, -0.1, 0.8);
	glRotatef(-90, 1, 0, 0);
	glutSolidCone(0.1, 0.25, 500, 500);
	glPopMatrix();

glColor3f(0.86, 0.80, 0.20);
	glPushMatrix();
	glTranslated(-0.95, -1.8, 0.8);
	glRotatef(-90, 1, 0, 0);
	glutSolidCone(0.1, 0.25, 500, 500);
	glPopMatrix();
	...
	glColor3f(0, 0.39, 0);
	glPushMatrix();
	glTranslated(-0.85, 1, 0.4);
	glRotatef(-90, 1, 0, 0);
	glutSolidCone(0.1, 0.25, 400, 500);
	glPopMatrix();

	//extra tree eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
void first()
{
    ...
    drawstring(400, 800, 0, "Bangalore Institute of Technology");
    drawstring(350, 750, 0, "Department of Computer Science and Engineering");

    drawstring(300, 700, 0, "Computer Graphics and Visualization Laboratory with Mini Project");
    drawstring(480, 600, 0, "3D House Viewing");
    drawstring(50, 150, 0,  "Press (Enter) to display the house");
    drawstring(600, 400, 0, "Submitted to:");
    drawstring(600, 350, 0, "Prof. D. R. Nagamani");
    drawstring(600, 300, 0, "Assistant Professor");
    drawstring(600, 250, 0, "Department of CS&E");

    drawstring(300, 400, 0, "Presented by:");
    drawstring(300, 350, 0, "Rakesh - 1BI19CS121");
    drawstring(300, 250, 0, "B Section");
